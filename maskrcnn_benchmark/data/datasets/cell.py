# Interface for accessing the Cervical Cell Segmentation dataset.
# https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocotools/coco.py


# The following API functions are defined:
#  CELL       - CELL api class that loads CELL annotation file and prepare data structures.
